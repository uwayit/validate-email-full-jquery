...
return domainZone}
function correctName(domainOnly){const corrections={'yandex':['yandax','yandeks','yandx','yangex','jandex','yadex','uandex','yndex','ayndex'],'bigmir':['digmir','biqmir','diqmir'],'mail':['mfil','meil','msil','maij','maill','mil','imeil','mael','maii','mali','mal','majl','maul','masl','maik','ail','naul','nail'],'icloud':['icloud','cloud','ikloud','iclout','icloub','cloub'],'gmail':['gamailcom','gmaill','gmailco','gmel','qm','gmjl','gmm','gmaa','ggmai','cmal','cail','gail','gmal','gmei','gmaij','gmajl','qnail','gnail','gmeil','gmall','jmail','gmaii','gmali','hmail','gmael','jimal','jmeil','qhail','gmoil','ghail','cmail','gamil','dmail','gmaik','gmоil','gimajl','gimail','qemail','gomail','gemeil','gemail','gamail','gameil','gmaul','qeimal','glail','gmaile','goi','qoi','gmfql','gmd']};for(let correctName in corrections){if(corrections[correctName].includes(domainOnly)){return correctName}}
return domainOnly}
...
function sintaksisValid(epart){if((epart.domainAll.indexOf('ya.ru')!=-1||epart.domainAll.indexOf('yandex')!=-1||epart.domainAll.indexOf('mail.ru')!=-1||epart.domainAll.indexOf('bk.ru')!=-1||epart.domainAll.indexOf('mail.ua')!=-1||epart.domainAll.indexOf('inbox.ru')!=-1||epart.domainAll.indexOf('gmail.com')!=-1||epart.domainAll.indexOf('list.ru')!=-1)&&(epart.domainAll.indexOf('..')!=-1||epart.domainAll.indexOf('-.')!=-1||epart.domainAll.indexOf('.-')!=-1||epart.domainAll.indexOf('_.')!=-1||epart.domainAll.indexOf('._')!=-1||epart.domainAll.indexOf('--')!=-1||epart.domainAll.indexOf('-_')!=-1||epart.domainAll.indexOf('_-')!=-1||epart.domainAll.indexOf('__')!=-1)){return!0}
